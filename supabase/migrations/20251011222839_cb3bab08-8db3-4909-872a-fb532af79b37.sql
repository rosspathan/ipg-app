-- Create or replace comprehensive balance reset function
...
DECLARE
  ...
  v_crypto_balance_records INTEGER := 0;
...
BEGIN
  ...
  -- Reset wallet_balances (crypto balances) to zero
  ...
  GET DIAGNOSTICS v_crypto_balance_records = ROW_COUNT;
  ...
  FROM (
    ...
    UNION
    SELECT user_id FROM public.wallet_balances
  ) AS all_users;
  ...
  INSERT INTO public.audit_logs (
    ...
    jsonb_build_object(
      ...
      'crypto_records_reset', v_crypto_balance_records,
  ...
  RETURN jsonb_build_object(
    ...
    'crypto_balance_records_reset', v_crypto_balance_records,
