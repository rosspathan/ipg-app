-- Fix execute_trade: Don't update remaining_amount (it's a generated column)
...
BEGIN
  ...
  -- Calculate proportional lock consumption for buyer based on remaining (which is amount - filled)
  ...
  -- ===== UPDATE ORDERS (don't update remaining_amount - it's generated) =====
...
-- Also fix place_order_atomic to not insert remaining_amount (it's generated)
