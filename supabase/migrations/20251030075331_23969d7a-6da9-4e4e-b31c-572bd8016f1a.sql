-- Fix atomic_badge_purchase to ensure price_bsk is always populated
...
BEGIN
  ...
  -- Step 6: Update badge holdings - ENSURE price_bsk is NEVER NULL
  INSERT INTO user_badge_holdings (
    ...
    p_previous_badge,
    NOW(),
    p_bsk_amount,  -- EXPLICIT value for price_bsk
    0,
    p_payment_ref
  )
  ON CONFLICT (user_id) DO UPDATE SET
    ...
    price_bsk = EXCLUDED.price_bsk,  -- EXPLICIT update
