...
-- Step 1: Set IPG balance to correct values
-- On-chain: 2 IPG, Locked: 3 IPG (from pending withdrawals)
-- Available should be: 2 IPG, Total will auto-calculate as 2 + 3 = 5 IPG
UPDATE public.wallet_balances
SET 
  available = 2.00000000,
  -- locked stays at 3.00000000 (from two pending withdrawals)
  -- total will auto-calculate as available + locked = 5.00000000
  updated_at = now()
