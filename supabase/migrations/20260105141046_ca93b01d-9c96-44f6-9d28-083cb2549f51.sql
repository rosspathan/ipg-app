-- Create atomic execute_trade function that combines settle + trade record + order updates
-- This prevents partial failures where balances are transferred but trade record fails
...
BEGIN
    ...
    -- 4. Update order filled amounts and statuses
