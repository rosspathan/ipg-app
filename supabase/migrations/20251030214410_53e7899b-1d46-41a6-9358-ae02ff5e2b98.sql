...
-- Fix yaleka9663@dropeso.com (user_id: 14281276-d9d4-44b1-baf6-038e02a4d9a1)
DO $$
DECLARE
...
BEGIN
  -- Insert or update referral link (no referral_code column, no lock_stage)
  INSERT INTO referral_links_new (
    user_id, sponsor_id, sponsor_code_used, 
    locked_at, first_touch_at, capture_stage
  )
  VALUES (
    v_user_id, 
    v_sponsor_id, 
  ...
  RAISE NOTICE 'Fixed user: yaleka9663@dropeso.com (%)' , v_user_id;
END $$;

-- Fix yegonij957@keevle.com (user_id: 6410525f-e204-45b1-950b-52a1b6859d27)
DO $$
DECLARE
...
BEGIN
  ...
  VALUES (
    ...
    NOW(), '2025-10-30 21:14:48+00', 'manual_repair'
  )
  ON CONFLICT (user_id) DO UPDATE
  SET sponsor_id = v_sponsor_id,
      sponsor_code_used = v_sponsor_code,
  ...
  RAISE NOTICE 'Fixed user: yegonij957@keevle.com (%)' , v_user_id;
END $$;

-- Fix facofe4355@hh7f.com (user_id: 0d62751c-f4d6-4dbe-8201-3f4211fa82f0)
DO $$
DECLARE
...
BEGIN
  ...
  VALUES (
    v_user_id, v_sponsor_id, v_sponsor_code,
    NOW(), '2025-10-30 21:31:17+00', 'manual_repair'
  )
  ON CONFLICT (user_id) DO UPDATE
  SET sponsor_id = v_sponsor_id,
      sponsor_code_used = v_sponsor_code,
  ...
  RAISE NOTICE 'Fixed user: facofe4355@hh7f.com (%)' , v_user_id;
END $$;