-- Replace atomic_badge_purchase to use correct badge_purchases columns
-- Drop existing variant to avoid ambiguity
...
BEGIN
  ...
  -- Get user's current badge (to detect upgrades and prevent duplicates)
  ...
  -- Legacy unified transaction log (if present)
