-- Fix execute_bsk_transfer to use correct tx_type values
...
BEGIN
  ...
  -- Record transaction for sender (outgoing) - FIXED: use 'debit' for tx_type
  ...
  -- Record transaction for recipient (incoming) - FIXED: use 'credit' for tx_type
  INSERT INTO unified_bsk_ledger (
    user_id,
    tx_type,
    tx_subtype,
