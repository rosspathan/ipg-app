  ...
  const formFields = [
    {
      ...
      label: "Campaign Name",
      value: formData.name,
      onChange: (value: string) => updateFormField("name", value),
    ...
    },
    {
      ...
      onChange: (value: string) => updateFormField("min_purchase_bsk", value),
      placeholder: "1000",
      required: true,
    },
    {
      ...
      onChange: (value: string) => updateFormField("max_purchase_bsk", value),
      placeholder: "100000",
      required: true,
    },
    {
      ...
      onChange: (value: string) => updateFormField("bonus_percent", value),
      placeholder: "25",
      required: true,
    ...
    },
    {
      ...
      onChange: (value: string) => updateFormField("fee_percent", value),
      placeholder: "0",
    ...
    },
    {
      ...
      onChange: (value: string) => updateFormField("fee_fixed", value),
      placeholder: "0",
    ...
    },
    {
      ...
      onChange: (value: string) => updateFormField("destination", value),
      options: [
    ...
    },
    {
      ...
      onChange: (value: string) => updateFormField("status", value),
      options: [
    ...
    },
    {
      ...
      onChange: (value: string) => updateFormField("start_at", value),
    ...
    },
    {
      ...
      onChange: (value: string) => updateFormField("end_at", value),
