        ...
        <div className="flex items-center">
          ...
          <div className="flex items-center gap-2 flex-shrink-0">
            <button
              ...
              className="w-8 h-8 flex items-center justify-center bg-muted rounded-full text-muted-foreground hover:text-foreground hover:bg-muted/80 active:scale-95 disabled:opacity-50 select-none touch-manipulation"
            >
