...
const BookRow = memo(({
  ...
  return (
    ...
    >
      ...
      {/* Price — 50% */}
      <span className={cn(
        "relative z-10 text-[13px] font-mono tabular-nums text-left leading-none truncate",
      ...
      {/* Amount — 50% */}
      <span className="relative z-10 text-[12px] font-mono tabular-nums text-right text-[#C7D2E0] leading-none truncate" style={{ fontWeight: 500, width: '50%', flexShrink: 0 }}>
        {fmtCompact(quantity)}
      </span>
    </div>
  );
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="flex items-center justify-between px-1.5 py-1 border-b border-[hsl(230,20%,15%)]/40">
        ...
        <select
          ...
          className="h-5 text-[10px] font-mono bg-[hsl(230,20%,10%)] border-none rounded px-1.5 text-[#C7D2E0] cursor-pointer focus:outline-none appearance-none"
        >
      ...
      {/* Column Header */}
      <div className="flex items-center px-2 py-1 text-[10px] font-bold text-[#94A3B8] uppercase tracking-wider border-b border-[hsl(230,20%,12%)]/30">
      ...
      >
        ...
        <span className={cn("text-[16px] font-extrabold font-mono tabular-nums tracking-tight", isPositive ? "text-[#00E676]" : "text-[#FF4D4F]")}>
      ...
      <div className="px-2 py-1.5 border-t border-[hsl(230,20%,18%)]/50">
        <div className="flex items-center gap-1.5">
          <span className="text-[10px] font-mono tabular-nums text-[#00E676] font-bold w-9">{bidPct.toFixed(1)}%</span>
          ...
          <span className="text-[10px] font-mono tabular-nums text-[#FF4D4F] font-bold w-9 text-right">{(100 - bidPct).toFixed(1)}%</span>
        </div>
      </div>
    </div>
  );
