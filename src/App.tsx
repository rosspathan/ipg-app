        ...
        <Routes>
          ...
          <Route path="/auth/verify-code" element={<Navigate to="/auth/login" replace />} />
              ...
              <Route path="wallet" element={<HomePageRebuilt />} />
                ...
                <Route path="programs/lucky-draw" element={<Navigate to="/app/programs" replace />} />
                <Route path="programs/lucky-draw/tickets" element={<Navigate to="/app/programs" replace />} />
                <Route path="programs/spin" element={<Navigate to="/app/programs" replace />} />
                <Route path="spin/history" element={<Navigate to="/app/programs" replace />} />
              ...
              <Route path="/admin/*" element={
                ...
                <Route path="trading-forensic" element={<React.Suspense fallback={<LoadingFallback />}>{React.createElement(React.lazy(() => import('./pages/admin/AdminTradingForensicAudit')))}</React.Suspense>} />
                ...
                <Route path="hot-wallet-audit" element={<React.Suspense fallback={<LoadingFallback />}>{React.createElement(React.lazy(() => import('./pages/admin/AdminHotWalletAudit')))}</React.Suspense>} />
                <Route path="hot-wallet-solvency" element={<React.Suspense fallback={<LoadingFallback />}>{React.createElement(React.lazy(() => import('./pages/admin/AdminHotWalletSolvency')))}</React.Suspense>} />
                <Route path="phantom-report" element={<React.Suspense fallback={<LoadingFallback />}>{React.createElement(React.lazy(() => import('./pages/admin/PhantomAccountsReport')))}</React.Suspense>} />
                ...
                <Route path="programs/control/lucky-draw/:moduleId?" element={<Navigate to="/admin/programs/control" replace />} />
                <Route path="programs/control/spin-wheel/:moduleId?" element={<Navigate to="/admin/programs/control" replace />} />
                ...
                <Route path="programs/control/insurance/:moduleId?" element={<Navigate to="/admin/programs/control" replace />} />
                ...
                <Route path="lucky-draw" element={<Navigate to="/admin/programs/control" replace />} />
                ...
                <Route path="fees" element={<React.Suspense fallback={<LoadingFallback />}>{React.createElement(React.lazy(() => import('./pages/admin/AdminFeeDashboard')))}</React.Suspense>} />
                <Route path="fees-simple" element={<React.Suspense fallback={<LoadingFallback />}>{React.createElement(React.lazy(() => import('./pages/admin/AdminFeeDashboard')))}</React.Suspense>} />
                <Route path="fee-collections" element={<React.Suspense fallback={<LoadingFallback />}>{React.createElement(React.lazy(() => import('./pages/admin/AdminFeeCollections')))}</React.Suspense>} />
              </Route>
              ...
              <Route path="/insurance" element={<Navigate to="/app/programs" replace />} />
              <Route path="/lucky-draw" element={<Navigate to="/app/programs" replace />} />
